...
- `JLPT_N2_MASTER.md`：完整知识地图和路线索引。按需读取，不必每次全读。
- `ROUTE_V2_2026-09-13.md`：当前执行路线、个人证据分析与时间模板；基础压缩和N2原题并行。
- `N2_PRACTICE_LOG.md`：N2首次作答、原题重做与新题迁移，辅助条件和用时分开记录。
...
- `archive/`：历史信息；state_snapshots仅保存旧状态快照，不代表错题已经解决。

- `materials/recent_n2/`：2023～2025及2026-07资料入口、核验清单与真题驱动安排；不是已收齐的完整近年题库。
